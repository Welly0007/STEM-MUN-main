    ...
    (function($) {
        var slide = function(ele,options) {
            ...
            var states = [
                ...
                { $zIndex: 10, width: 211, height: 280, top: 0, left: 0, $opacity: 1 },
        ...
        (function($) {
            var slide = function(ele,options) {
                ...
                var states = [
                    ...
                    { $zIndex: 9, width: 0, height: 0, top: 125, left: -200, $opacity: 1 },
                    { $zIndex: 10, width: 211, height: 280, top: 0, left: 0, $opacity: 1 },
                    { $zIndex: 9, width: 211, height: 280, top: 0, left: 261, $opacity: 1 },
        ...
        (function($) {
            var slide = function(ele,options) {
                ...
                var states = [
                    ...
                    { $zIndex: 9, width: 200, height: 275, top: 40, left: 0, $opacity: 0.8 },
                    { $zIndex: 10, width: 281, height: 350, top: 0, left: 245, $opacity: 1 },
                    { $zIndex: 9, width: 200, height: 275, top: 40, left: 558, $opacity: 0.8 },
