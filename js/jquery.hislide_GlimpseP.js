    ...
    if(query.matches){
        ...
        (function($) {
            var slide = function(ele,options) {
                ...
                $.extend(true, setting, options);
                var states = [
                    { $zIndex: 1, width: 200, height: 295, top: 25, left: 0, $opacity: 0.8 },
                    { $zIndex: 2, width: 281, height: 350, top: 0, left: 245, $opacity: 1 },
                    { $zIndex: 1, width: 200, height: 295, top: 25, left: 558, $opacity: 0.8 },
                    { $zIndex: 0, width: 0, height: 0, top: 198, left: -800, $opacity: 0.8 },
