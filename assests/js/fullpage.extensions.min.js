...
! function(e, t, n, o, r) {
    ...
    function Un(e) {
        ...
        for (var t = 1, n = arguments.length; t < n; ++t) {
            var o = arguments[t];
            if (o)
                for (var r in o) o.hasOwnProperty(r) && ("[object Object]" !== Object.prototype.toString.call(o[r]) ? e[r] = o[r] : e[r] = Un(e[r], o[r]))
        }
        return e
    }
    ...
    return an.NodeList && !NodeList.prototype.forEach && (NodeList.prototype.forEach = function(e, t) {
        ...
        function(e, b) {
            ...
            function Gt(e) {
                ...
                else if (b.autoScrolling && !b.scrollBar) Jn(w, {
                    top: -t + "px"
                }), m.test.top = -t + "px";
                else {
                    var n = Fe(t);
            ...
            function tn(t, n, o, r) {
                var e, i = (e = t).self != an && Fn(e, zn) ? e.scrollLeft : !b.autoScrolling || b.scrollBar ? go() : e.offsetTop,
                    l = n - i,
                    a = 0;
                Y = !0;
                var c = function() {
